...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 12 09:20:41 2026
...
f, a = plt.subplots(len(yrs), 1, figsize=(15, 8), sharey=True)
...
plt.savefig('/neta/xrb/META/ir_calib_calendar_1m.png')
plt.show()
...
for current_filter in filter_map1.keys():
    ...
    for id, year in enumerate(yrs):
        ...
        if year != yrs[-1]:
            axes[id].tick_params(axis='x', which='both',
    ...
    plt.savefig(f'/neta/xrb/META/ir_calib_calendar_{current_filter}_1m.png')
    plt.show()