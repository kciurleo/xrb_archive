...
for key in data:
    ...
    combined.append(
        df[["MJD", "mag_scaled", "mag_corr_err"]]
    )
...
plt.title(
    f"Combined Passive-State Folded Light Curve\n"
    f"Period = {best_period:.4f} hr"
)
