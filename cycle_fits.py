...
df=pd.read_csv('/neta/xrb/AqlX-1/product/AqlX-1_R_corrected_lc_4_27.csv', low_memory=False)
...
#df.to_csv('/neta/xrb/AqlX-1/product/AqlX-1_R_corrected_lc_4_27.csv')
